...
class Card {
    ...
    create() {
        ...
        variables_1.gameCardsDiv.appendChild(card_background);
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.showEndWinButton = exports.showEndLoseButtons = exports.hideVideo = exports.showVideo = exports.clearPreviousGame = void 0;
const variables_1 = __webpack_require__(/*! ../../variables */ "./src/js/variables.ts");
...
exports.clearPreviousGame = clearPreviousGame;
function showVideo(video) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        variables_1.timer.style.animation = "none";
    });
}
exports.showVideo = showVideo;
function hideVideo(sound) {
    sound.play();
    variables_1.divVideo.style.animation = "hide 2s";
    variables_1.divVideo.style.animationFillMode = "forwards";
    variables_1.divVideo.style.display = "none";
}
...
variables_1.try_again === null || variables_1.try_again === void 0 ? void 0 : variables_1.try_again.addEventListener("click", function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield door_1.changeView("game_start", "game_board");
...
function losingProcedure() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        variables_1.timeCounter.innerHTML = "0";
        index_1.clearPreviousGame();
...
variables_1.endScreenLoseMM.addEventListener("click", function () {
    door_1.changeView("game_end", "game_start");
    variables_1.endScreenLose.style.display = "none";
});
variables_1.endScreenLoseTA.addEventListener("click", function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield init_game_1.initGame();
        yield play_1.mainGame();
        yield door_1.changeView("game_start", "game_board");
...
function summary() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const totalSegmentPointsTimeLeft = yield summarizePoints(timeLeft, variables_1.messageParts.timeLeft, variables_1.messageScores.timeLeftScore, variables_1.multipliers.multiplieTimeLeft);
        yield summarizeTotalPoints(totalSum + totalSegmentPointsTimeLeft, totalSegmentPointsTimeLeft);
        const totalSegmentPointsTimeBonus = yield summarizePoints(timeBonus, variables_1.messageParts.timeBonus, variables_1.messageScores.timeBonusScore, variables_1.multipliers.multiplieTimeBonus);
        yield summarizeTotalPoints(totalSum + totalSegmentPointsTimeBonus, totalSegmentPointsTimeBonus);
        const totalSegmentPointsTimeStart = yield summarizePoints(timeStart, variables_1.messageParts.timeStart, variables_1.messageScores.timeStartScore, variables_1.multipliers.multiplieTimeStart);
        yield summarizeTotalPoints(totalSum - totalSegmentPointsTimeStart, totalSegmentPointsTimeStart);
        const totalSegmentPointsMoves = yield summarizePoints(madeMoves, variables_1.messageParts.madeMoves, variables_1.messageScores.madeMovesScore, variables_1.multipliers.multiplieMoves);
        ...
        return new Promise((resolve, reject) => {
            ...
            const incrementTotalScore = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                if (x < totalSumWithValueToUpdate) {
                    variables_1.messageScores.totalPointsScore.innerHTML = `${x + 5}`;
                    x += 5;
                }
                else if (x > totalSumWithValueToUpdate) {
                    variables_1.messageScores.totalPointsScore.innerHTML = `${x - 5}`;
                    x -= 5;
                    variables_1.messageScores.totalPointsScore.style.animation = "squintingTimer .4s infinite";
                }
                else {
                    clearInterval(incrementTotalScore);
                    yield updateTotalSum.next(valueToUpdate);
                    variables_1.messageScores.totalPointsScore.style.animation = "none";
                    resolve();
                }
            }), 1);
        });
...
function showTypeNickNamePanel(playerTotalScore) {
    ...
    setTimeout(() => variables_1.pointsScreen.style.display = "none", 2000);
    ...
    window.addEventListener('keypress', function (e) {
        if (e.key === 'Enter')
            hideNicknameScreen(playerTotalScore);
    });
}
function winningProcedure() {
    return __awaiter(this, void 0, void 0, function* () {
        variables_1.lose.style.display = 'none';
        index_1.clearPreviousGame();
        yield door_1.changeView("game_board", "game_end");
        variables_1.messageParts.totalPoints.style.display = "flex";
        variables_1.pointsScreen.style.display = "block";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initGame = exports.gameCards = void 0;
...
function initGame() {
    return __awaiter(this, void 0, void 0, function* () {
        variables_1.gameCardsDiv.innerHTML = "";
        yield getCards();
        exports.gameCards.splice(0, exports.gameCards.length);
        while (exports.gameCards.length < originCards.length * 2) {
            const i = Math.floor(Math.random() * originCards.length);
            const isThereTwoSuchCards = exports.gameCards.filter(el => el === originCards[i]);
            if (isThereTwoSuchCards.length == 2) {
                continue;
            }
            else {
                exports.gameCards.push(originCards[i]);
                const card = new card_1.Card(size, size_mobile_screen_landscape, size_mobile_screen_portrait, 1, originCards[i]);
                card.create();
            }
        }
    });
...
function mainGame() {
    ...
    exports.totalPairs = init_game_1.gameCards.length / 2;
    //catches all cards
    ...
    playableCards.forEach((playableCard, index) => {
        playableCard.addEventListener("click", function () {
            if (playableCard.style.opacity !== "0" && blockRevealMoreThanTwoCards == false) {
                ...
                playableCard.style.backgroundImage = `url(./images/cards/${init_game_1.gameCards[index]}.png)`;
                if (oneVisible == false) {
                    ...
                    exports.turnCounter++;
                    variables_1.scoreCounter.innerHTML = `${exports.turnCounter}`;
                    if (init_game_1.gameCards[firstCardIndex] == init_game_1.gameCards[index] && firstCardIndex != index) {
            ...
            const startTimer = setInterval(function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (exports.currentTime <= 5 && exports.currentTime >= 0) {
                        variables_1.timer.style.animation = "squintingTimer .4s infinite";
                        variables_1.timer.style.animationDirection = "alternate";
                    }
...
variables_1.bestScoresButton === null || variables_1.bestScoresButton === void 0 ? void 0 : variables_1.bestScoresButton.addEventListener("click", function () {
    door_1.changeView("game_bestScores", "game_start");
});
...
variables_1.switchSoundButton === null || variables_1.switchSoundButton === void 0 ? void 0 : variables_1.switchSoundButton.addEventListener("click", sound_1.switchSoundFunction);
...
exports.play = play;
function options() {
    door_1.changeView("game_start", "game_options");
}
...
variables_1.optTimerDiv === null || variables_1.optTimerDiv === void 0 ? void 0 : variables_1.optTimerDiv.children[0].addEventListener("click", function () {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.unmuteBackgroundSound = exports.switchSoundFunction = void 0;
const variables_1 = __webpack_require__(/*! ../variables */ "./src/js/variables.ts");
...
exports.switchSoundFunction = switchSoundFunction;
...
exports.unmuteBackgroundSound = unmuteBackgroundSound;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.nicknameScreen = exports.pointsScreen = exports.end_screen_win_button = exports.try_again = exports.main_menu = exports.end_screen_lose_buttons = exports.message_lose = exports.summary = exports.messageScores = exports.totalPoints = exports.madeMoves = exports.timeBonus = exports.timeLeft = exports.timeStart = exports.cardsNumber = exports.messageParts = exports.end_screen_message = exports.multipliers = exports.timeCounter = exports.timer = exports.scoreCounter = exports.divVideo = exports.loseVideo = exports.winVideo = exports.gameCardsDiv = exports.backgroundSoundIndex = exports.audios = exports.loseSound = exports.winSound = exports.cardSound = exports.backgroundSound = exports.switchSoundButton = exports.doorRight = exports.doorLeft = exports.overlay = exports.bestScoresButton = exports.optButton = exports.plusTime = exports.minusTime = exports.clockSeconds = exports.clockMinutes = exports.clock = exports.optTimerDiv = exports.optCardsNumberDiv = exports.enumTimer = exports.enumCardsNumber = exports.bestScoresMenuButton = exports.optionsMenuButton = exports.playMenuButton = exports.gameStart = void 0;
exports.endScreenLoseTA = exports.endScreenLoseMM = exports.endScreenLose = exports.lose = exports.buttonNicknamePoints = exports.inputPoints = exports.spanPoints = void 0;
// menu
...
// game
exports.gameCardsDiv = document === null || document === void 0 ? void 0 : document.querySelector("#game_cards");
//videos
...
var x = __webpack_require__(/*! ./data.json */ "./src/js/data.json");
