...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loadDoc": () => (/* binding */ loadDoc)
/* harmony export */ });
...
/* harmony import */ var _loadDoc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../loadDoc */ "./src/js/loadDoc.ts");
...
function changeView(filename) {
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            resolve((0,_loadDoc__WEBPACK_IMPORTED_MODULE_1__.loadDoc)(filename));
...
/* harmony import */ var _key__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./key */ "./src/js/menu/navigation/key.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function play() {
    return __awaiter(this, void 0, void 0, function* () {
        // await initGame(); 
        // await mainGame();
        yield (0,_door__WEBPACK_IMPORTED_MODULE_1__.changeView)("play.php");
        // await startTimer();
    });
}
function options() {
    (0,_door__WEBPACK_IMPORTED_MODULE_1__.changeView)("options.php");
}
function bestScores() {
    (0,_door__WEBPACK_IMPORTED_MODULE_1__.changeView)("bestscores.php");
}
...
function windowKeyboard(e) {
    if (_variables__WEBPACK_IMPORTED_MODULE_2__.gameStart.style.display != "none") {
        const button = document.querySelector(".main_button.active");
        switch (e.key) {
            case "ArrowDown":
                (0,_key__WEBPACK_IMPORTED_MODULE_3__.ArrowDown)(button);
                break;
            case "ArrowUp":
                (0,_key__WEBPACK_IMPORTED_MODULE_3__.ArrowUp)(button);
                break;
            case "Enter":
                (0,_key__WEBPACK_IMPORTED_MODULE_3__.Enter)(button, play, options, bestScores);
                break;
            default: null;
        }
    }
